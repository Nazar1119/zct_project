...
declare class Database {
     ...
     */
    retrieve<TMetadata>({ question, similarityThreshold, topK, namespace, contextFilter, }: VectorPayload): Promise<{
        data: string;
        id: string;
        metadata: TMetadata;
    }[]>;
...
declare class ContextService {
    ...
    addMany(args: AddContextPayload[] | string[]): Promise<({
        success: true;
        ids: string[];
    } | {
        success: false;
    ...
    _getContext<TMetadata extends object>(optionsWithDefault: ModifiedChatOptions, input: string | number[], debug?: ChatLogger): langsmith_traceable.TraceableFunction<(sessionId: string) => Promise<{
